	...
	<div id="page-wrapper">
		...
		<div class="con">
			...
			<div class="conte" id="cinterno" style="display: none;">
				...
				<span class="apartados" id="verc">Descubrir la importancia que tiene cada participante dentro de la empresa.</span><br>
				<span class="apartados" id="verc">Definir el concepto de servicio interno.</span><br>
				<span class="apartados" id="verc">Desarrollar conductas que les permitirán ofrecer un mejor servicio al cliente con calidad.</span><br>
			</div>
			<div class="conte" id="ctelefono" style="display: none;">
				...
				<span class="apartados" id="verc">Fundamentos para ofrecer un servicio de calidad al cliente.</span><br>
				<span class="apartados" id="verc">Técnicas telefónicas que permitan una comunicación efectiva con el cliente.</span><br>
				<span class="apartados" id="verc">Solución de conflictos en la atención telefónica.</span><br>
			</div>
		</div>
		</div>
