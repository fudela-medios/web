...
<html>
	...
	<body >
		<div id="page-wrapper">
				...
				<div class="barra-regreso">
					<div class="contenedor-barra">
						<div class="elementos-barra">
							...
							<a class="lugar" href="pared.php">
								<span class="lugar-barra">Pared de escalar</span>
							</a>
						</div>
						<div class="elementos-barra">
			...
			<div>
				<!-- -------------------- Pared escalar ---------------->
				<h2 align="center">Pared de escalar</h2>
				<div class="galeria">
					<div class="contenedor_imagen">
						<div class="galeria_item">
							<img class="galeria_img" src="assets/css/images/catalogo/pared/1.jpg">
						</div>
					</div>
					<div class="contenedor_imagen">
						<div class="galeria_item">
							<img class="galeria_img" src="assets/css/images/catalogo/pared/2.jpg">
						</div>
					</div>
					<div class="contenedor_imagen">
						<div class="galeria_item">
							<img class="galeria_img" src="assets/css/images/catalogo/pared/3.jpg">
						</div>
					</div>
					<div class="contenedor_imagen">
						<div class="galeria_item">
							<img class="galeria_img" src="assets/css/images/catalogo/pared/4.jpg">
						</div>
					</div>
					<div class="contenedor_imagen">
						<div class="galeria_item">
							<img class="galeria_img" src="assets/css/images/catalogo/pared/5.jpg">
						</div>
					</div>
					<div class="contenedor_imagen">
						<div class="galeria_item">
		...
		<!-- Scripts -->
			...
			<script src="assets/js/modal15.js"></script>
		</div>
	</body>
</html>