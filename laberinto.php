...
<html>
	...
	<body >
		<div id="page-wrapper">
				...
				<div class="barra-regreso">
					<div class="contenedor-barra">
						<div class="elementos-barra">
							...
							<a class="lugar" href="laberinto.php">
								<span class="lugar-barra">Laberinto</span>
							</a>
						</div>
						<div class="elementos-barra">
			...
			<div>
				<!-- -------------------- Laberinto --------------------- -->
				<h2 align="center">Laberinto</h2>
				<div class="galeria">
					<div class="contenedor_imagen">
						<div class="galeria_item">
							<img class="galeria_img" src="assets/css/images/catalogo/laberinto/1.jpg">
						</div>
					</div>
					<div class="contenedor_imagen">
						<div class="galeria_item">
							<img class="galeria_img" src="assets/css/images/catalogo/laberinto/2.jpg">
						</div>
					</div>
				</div>
			</div>
		...
		<!-- Scripts -->
			...
			<script src="assets/js/modal16.js"></script>
		</div>
	</body>
</html>