			    ...
			    <div class="barra-regreso">
					<div class="contenedor-barra">
					    <div class="elementos-barra">
							...
							<a class="lugar" href="camping.php">
								<span class="lugar-barra">Camping</span>
							</a>
						</div>
						<div class="elementos-barra">
				...
				<div class="galeria">
					<div class="contenedor_imagen">
						<div class="galeria_item">
							<img class="galeria_img" src="assets/css/images/catalogo/campingg/1.png">
						</div>
					</div>
					<div class="contenedor_imagen">
						<div class="galeria_item">
							<img class="galeria_img" src="assets/css/images/catalogo/campingg/2.png">
						</div>
					</div>
					<div class="contenedor_imagen">
						<div class="galeria_item">
							<img class="galeria_img" src="assets/css/images/catalogo/campingg/3.png">
						</div>
					</div>
					<div class="contenedor_imagen">
						<div class="galeria_item">
							<img class="galeria_img" src="assets/css/images/catalogo/campingg/4.png">
						</div>
					</div>
					<div class="contenedor_imagen">
						<div class="galeria_item">
							<img class="galeria_img" src="assets/css/images/catalogo/campingg/5.png">
						</div>
					</div>
					<div class="contenedor_imagen">
						<div class="galeria_item">
