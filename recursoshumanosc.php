	...
	<div id="page-wrapper">
		...
		<div class="con">
			...
			<div class="conte" id="r" style="display: none;">
				...
				<span class="apartados" id="verc">Identificar el perfil ideal para un puesto de trabajo de acuerdo a las necesidades de la empresa.</span><br>
				<span class="apartados" id="verc">Aplicar el proceso de selección y reclutamiento de manera óptima.</span><br>
				<span class="apartados" id="verc">Realizar de manera adecuada una entrevista de trabajo.</span><br>
				<span class="apartados" id="verc">Guiar al nuevo personal a las estrategias de la empresa.</span><br>
			</div>
			<div class="conte" id="n" style="display: none;">
				...
				<span class="apartados" id="verc">Reglas de negociación.</span><br>
				<span class="apartados" id="verc">Desarrollo de la negociación.</span><br>
				<span class="apartados" id="verc">Solución de conflictos a través de la negociación.</span><br>
			</div>
			<div class="conte" id="c" style="display: none;">
				...
				<span class="apartados" id="verc">Conocer las bases legales de una contratación y de la terminación de un contrato laboral </span><br><span class="apartados" id="verc"> establecidas en la Ley Federal de Trabajo.</span><br>
				<span class="apartados" id="verc">Desarrollar el procedimiento correcto para contratar y despedir personal.</span><br>
			</div>
		</div>
		</div>
		<?php
